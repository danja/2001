...
/**
 *  Extract RDF logic from a SAX event stream. <blockquote><em>This module, both
 *  source code and documentation, is in the Public Domain, and comes with
 *  <strong>NO WARRANTY</strong> .</em></blockquote> <p>
 *
 *  This is a SAX2 filter designed to extract RDF logic from a stream of SAX2
 *  events. The RDF-related XML events (elements, character data, etc.) are
 *  removed from the stream and the RDF itself is reported through the
 *  RDFHandler.</p> <p>
 *
 *  The SAX2 feature "http://megginson.com/sax/features/rdf" controls RDF
 *  processing; if it is true (the default value for this filter), RDF
 *  processing will be performed; if it is false, all XML markup will be passed
 *  through unmodified.</p> <p>
 *
 *  The SAX2 property "http://megginson.com/sax/properties/rdf-handler" allows
 *  the handler for RDF events to be set or queried. See RDFHandler for more
 *  information, and note that that class has convenience constants for both the
 *  feature and the property.</p> <p>
 *
 *  If there are RDF-specific errors or warnings, they are reported through the
 *  SAX2 error handler. The argument will be an RDFException rather than a
 *  general SAXParseException, so it is easily distinguishable using instanceof
 *  or during a catch. If the client application does not set an error handler,
 *  RDF errors will go unreported and the results will be unpredictable.</p> <p>
 *
 *  This filter reifies statements only when a bagID is present, or when the
 *  property element itself contains an ID.</p> <p>
 *
 *  This version of the filter is designed for SAX2beta2.</p>
 *
...
public class RDFFilter extends XMLFilterImpl {
  ...
  private boolean rdfProcessing = true;
  ...
  /**
   *  Set the value of a SAX2 feature. <p>
   *
   *  Intercept requests for http://megginson.com/sax/features/rdf, and pass all
   *  others on through.</p>
   *
  ...
  /**
   *  Set the value of a SAX2 property. <p>
   *
   *  Intercept requests for http://megginson.com/sax/properties/rdf-handler,
  ...
  /**
   *  Grab the locator as it flies by. <p>
   *
   *  If a locator is supplied, the RDF filter will use it for RDF error
   *  reporting.</p>
   *
  ...
  /**
   *  Get the value of a SAX2 feature. <p>
   *
   *  Intercept requests for http://megginson.com/sax/features/rdf, and pass all
   *  others on through.</p>
   *
   * @param  name                           The feature name.
   * @return                                The current feature status (true or
   *      false).
   * @exception  SAXNotSupportedException   Description of Exception
   * @exception  SAXNotRecognizedException  Description of Exception
  ...
  /**
   *  Get the value of a SAX2 property. <p>
   *
   *  Intercept requests for http://megginson.com/sax/properties/rdf-handler,
   *  and pass all others on through.</p>
   *
   * @param  name                           The property name.
   * @return                                The current property value as an
   *      Object.
   * @exception  SAXNotSupportedException   Description of Exception
   * @exception  SAXNotRecognizedException  Description of Exception
   ...
   *
   *  The RDF filter overrides this method so that it can (re)initialize the
   *  filter's state.</p>
   *
  ...
  /**
   *  Start an XML element. <p>
   *
   *  If RDF processing is enabled, the RDF filter will pull RDF-related markup
   *  out of the SAX event stream and replace it with higher-level, abstract RDF
   *  events.</p>
   *
...
//System.exit(0);
  ...
  /**
   *  End an XML element. <p>
   *
   *  Extract any RDF-specific events, and pass the rest on through.</p>
   *
   * @param  uri               The element's Namespace URI.
   * @param  localName         The element's local name.
   * @param  rawName           The elemnet's raw XML 1.0 name.
  ...
  /**
   *  Whitespace in element content. <p>
   *
   *  Extract any RDF-specific events, and pass the rest on through.</p>
   *
   * @param  ch                An array of characters.
   ...
   * @return         true if the array segment contains only whitespace, false
   *      otherwise.
   */
  ...
  /**
   *  Check for the name of a predefined RDF property. <p>
   *
   *  This method tests whether the name provided is the name of a predefined
   *  RDF property.</p>
   *
   * @param  name  The name to test.
   * @return       The RDFProperty value
   */
  ...
  /**
   *  Check for the name of a predefined RDF resource property. <p>
   *
   *  Some predefined RDF properties explicitly expect resource values; this
   *  method checks to see if the name given matches on of those.</p>
   *
   * @param  name  Description of Parameter
   * @return       The RDFResourceProperty value
   */
  ...
  /**
   *  Start an RDF resource description. <p>
   *
   *  This method handles the start of a regular RDF resource description,
   *  including attribute processing. The startElement callback invokes this
   *  when it determines that an element starts a resource description; the
   *  logic of sorting out the RDF is here.</p>
   *
   * @param  uri               The element's Namespace URI.
   ...
   *  End a resource. <p>
   *
   *  This method handles the end of a regular RDF resource description. The
   *  endElement callback invokes this when it determines that an element starts
   *  a property. Currently, no special action is required.</p>
   *
  ...
  /**
   *  Start a property element. <p>
   *
   *  This method handles the start of a regular RDF property, including
   *  attribute processing. The startElement callback invokes this when it
   *  determines that an element starts a property; the logic of sorting out the
   *  RDF is here.</p>
   *
   * @param  uri               The property element's Namespace URI.
   * @param  localName         The property element's local name.
  ...
  /**
   *  Handle the end of a resource property element. <p>
   *
   *  This method reports the property to the RDF handler.</p>
   *
   * @param  uri               The property element's Namespace URI.
   * @param  localName         The property element's local name.
   * @exception  SAXException  Description of Exception
  ...
  /**
   *  Handle the end of a composite property element. <p>
   *
   *  This method reports the property to the RDF handler.</p>
   *
   * @param  uri               The property element's Namespace URI.
  ...
  /**
   *  Handle the end of a literal property element. <p>
   *
   *  Report the property to the RDF handler.</p>
   *
   * @param  uri               The property element's Namespace URI.
   * @param  localName         The property element's local name.
   * @exception  SAXException  Description of Exception
  ...
  /**
   *  Handle the end of an XML literal property. <p>
   *
   *  Report the end to the RDF handler.</p>
   *
   * @param  uri               The property element's Namespace URI.
   * @param  localName         The property element's local name.
   * @exception  SAXException  Description of Exception
  ...
  /**
   *  Report all property attributes specified. <p>
   *
   *  This method walks through a property list and reports all property
   *  attributes in it; that is, all attributes not in the RDF or XML
   *  Namespaces, together with rdf:value.</p>
   *
  ...
  /**
   *  Report an atomic statement. <p>
   *
   *  This method invokes the literalStatement or resourceStatement methods in
   *  the RDF handler. It also reifies the property if there is a bagID or a
   *  statement ID.</p> <p>
   *
   *  This method also handles rdf:li property, replacing it with rdf:_n.</p>
   *
   ...
   * @param  bagId             Description of Parameter
   * @param  statementId       Description of Parameter
   * @exception  SAXException  Description of Exception
   */
  ...
  /**
   *  Issue an RDF warning. <p>
   *
   *  The warning is reported to the SAX2 error handler, if any, with an
   *  RDFException as the argument.</p>
   *
  ...
  /**
   *  Issue an RDF error. <p>
   *
   *  The error is reported to the SAX2 error handler, if any, with an
   *  RDFException as the argument.</p>
   *
   ...
   *  Push a new state. <p>
   *
   *  This method manages creating a new state. States are kept in an array and
   *  reused, so the number of states allocated is never greater than the depth
   *  of the elements in the XML document.</p>
   */
  ...
  /**
   *  Generate an ID for an anonymous resource. <p>
   *
   *  The generated ID is surrounded by braces so that it's easily
   *  distinguishable from a proper URI.</p>
   *
  ...
  /**
   *  Internal: a single RDF processing state. <p>
   *
   *  These states are designed to be reused.</p>
   *
   * @author     Danny Ayers
   * @created    26 March 2001
   */
