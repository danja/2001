...
/**
 *  RDF-specific exception. <blockquote><em>This module, both source code and
 *  documentation, is in the Public Domain, and comes with <strong>NO WARRANTY
 *  </strong>.</em></blockquote> <p>
 *
 *  This class is a specialized subclass of SAXParseException designed for
 *  reporting RDF-specific errors.</p>
 *
...
public class RDFException extends SAXParseException {
  ...
  /**
   *  Construct a new RDF exception. <p>
   *
   *  Public and system IDs will be null, and line and column number will be -1.
   *  </p>
   *
   ...
   *
   * @param  message  The error message.
   * @param  locator  A SAX2 locator containing the location of the error.
   */
