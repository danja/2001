...
/**
 *  When an XML file containing a set of Properties is parsed, 
 *  SAX events call the methods of this class, and each Properties
 *  object is placed into a HashMap (referenced by name). 
 *
 *  Uses SAX2 - in this version the Xerces implementation.
 *
 *@author     Danny Ayers 
...
public class XMLProperties extends DefaultHandler {
	...
	/**
	 *  Sets the Log attribute of the XMLProperties object 
	 *  a PrintStream to which error/log messages can be passed.
	...
	public void endElement(String uri, String local, String qname) {
		...
		if (local.equals("property")) {
			properties.setProperty(listname + "." + propname, propvalue);
